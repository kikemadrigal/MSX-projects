...
tasklist | find /i "%MyProcess%">nul  && (echo %MyProcess% Already running) || start ..\..\..\tools\emulators\openmsx\openmsx.exe -script ..\..\..\tools\emulators\openmsx\emul_start_config.txt
