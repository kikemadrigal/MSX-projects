...
mover_personaje_arriba:
    ...
    ld de, 60000 ;Start address of memory
    ...
    ld a,(60000)
    sub 1
    ld (60000), a ; se lo metemos al atributo
    
    ld hl, 60000 ; la rutina LDIRVM necesita haber cargado previamente la dirección de inicio de la RAM, para saber porqué he puesto 0000 fíjate este dibujo https://sites.google.com/site/multivac7/files-images/TMS9918_VRAMmap_G2_300dpi.png ,así es como está formado el VDP en screen 2
    ld de, #1b00; la rutina necesita haber cargado previamente con de la dirección de inicio de la VRAM          
