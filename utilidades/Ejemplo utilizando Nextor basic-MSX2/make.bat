...
rem java -jar tools/deletecomments/deletecomments1.4.jar src/main.bas obj/game.bas  
java -jar ..\..\tools\MSXTools\MSXTools.jar -m=d -o=src\main.bas 
move  .\main-del.bas obj/game.bas
...
rem start /wait tools/emulators/openmsx/openmsx.exe -machine Philips_NMS_8255 -diska ./obj
 start /wait ..\..\tools\emulators\openmsx\openmsx.exe -machine Panasonic_FS-A1ST -diska .\obj
rem MSX2+
