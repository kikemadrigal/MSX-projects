...
rem MSX 1
rem start /wait ..\..\tools\emulators\openmsx\openmsx.exe -machine Sony_HB-55P -ext Sony_HBD-50 -diska %TARGET_DSK%
rem MSX2
rem start /wait ..\..\tools\emulators\openmsx\openmsx.exe -machine Philips_NMS_8255 -diska %TARGET_DSK%
rem MSX2+
start /wait ..\..\tools\emulators\openmsx\openmsx.exe -machine Sony_HB-F1XV -diska %TARGET_DSK%