...
:preparar_archivos_fuente
    ...
    start /wait ..\..\tools\dignifier\msxbadig\msxbadig.py objects\main.bad 
    ...
    start /wait ..\..\tools\dignifier\msxbatoken\msxbatoken.py objects\main.asc
...
:abrir_emulador_con_rom   
    ...
    rem start /wait ..\..\tools\emulators\BlueMSX\blueMSX.exe -rom1 %TARGET_ROM%
    rem start /wait tools/emulators/fMSX/fMSX.exe -cas %TARGET_ROM%
    start /wait ..\..\tools\emulators\openmsx\openmsx.exe -machine Philips_NMS_8255 -carta %TARGET_ROM%
goto:eof
