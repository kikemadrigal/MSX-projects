...
start /wait ..\..\tools\sjasm\sjasm.exe src\word0.asm
start /wait ..\..\tools\sjasm\sjasm.exe src\word1.asm
...
rem java -jar tools/deletecomments/deletecomments.jar src/main.bas obj/main.bas  
java -jar ..\..\tools\MSXTools\MSXTools.jar -m=d -o=src\main.bas
move /y main-del.bas obj/main.bas 
