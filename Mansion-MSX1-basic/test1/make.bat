...
OPENMSX=openmsx.exe
OPENMSX_PATH=..\..\tools\emulators\openmsx\
...
:preparar_archivos_fuente
    ...
    rem java -jar tools\deletecomments1.4\deletecomments1.4.jar obj\temp.bas obj\game.bas
    java -jar ..\..\tools\MSXTools\MSXTools.jar -m=d -o=obj\temp.bas
    move /y temp-del.bas obj\game.bas 
...
:crear_dsk
    ...
    if not exist ..\..\tools\Disk-Manager GOTO :not_exist_disk_manager
    rem Crear nuevo dsk
...
:abrir_emulador_con_rom   
    ...
    rem start /wait tools/emulators/BlueMSX/blueMSX.exe -rom1 %TARGET_ROM%
